...
#ifndef __CVL53L1X_H__
#define __CVL53L1X_H__
...
private:
   ...
   enum regAddr : uint16_t
   {
    ...
    static const uint32_t TimingGuard = 4528;		// TimingGuard = LOWPOWER_AUTO_OVERHEAD_BEFORE_A_RANGING + LOWPOWER_AUTO_OVERHEAD_BETWEEN_A_B_RANGING + vhv   = 1448 + 2100 + 980 = 4528
...
public:
	...
	bool DataReady(void);
	bool GetReading(uint16_t &reading_mm);
...
protected:
private:
	CVL53L1X( const CVL53L1X &c );
	CVL53L1X& operator=( const CVL53L1X &c );

}; //CVl53L1X

#endif //__CVL53L1X_H__
