...
#ifndef __CTIMERS_H__
#define __CTIMERS_H__
/* ============================================================================= */
...
/*@{*/
	...
	typedef struct {
		TcChannel1  TC_CHANNEL[TCCHANNEL_NUMBER]; /**< \brief (Tc Offset: 0x0) channel = 0 .. 2 */
...
protected:
private:
	CTimers( const CTimers &c );
	CTimers& operator=( const CTimers &c );
